...
ROBOT_PACKAGE_FOLDER    = 'fred_robot_package' # Diretório com os módulos do robô FRED
ROBOT_TOPIC_BASE        = 'FRED_14194525' # You can change it if you wish to use another robot. 'FRED_1021516' (FRED), 'FRED_14194525' (Frida) ou 'EVA' (robô EVA).
